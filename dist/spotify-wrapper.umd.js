...
var getAlbum = function getAlbum(id) {
  return fetch("".concat(_config__WEBPACK_IMPORTED_MODULE_0__.default, "/albums/").concat(id)).then(_utils__WEBPACK_IMPORTED_MODULE_1__.default);
};

var getAlbums = function getAlbums(ids) {
  return fetch("".concat(_config__WEBPACK_IMPORTED_MODULE_0__.default, "/albums/").concat(ids)).then(_utils__WEBPACK_IMPORTED_MODULE_1__.default);
};

var getAlbumTracks = function getAlbumTracks(id) {
  return fetch("".concat(_config__WEBPACK_IMPORTED_MODULE_0__.default, "/albums/").concat(id, "/tracks")).then(_utils__WEBPACK_IMPORTED_MODULE_1__.default);
};
...
var search = function search(query, type) {
  return fetch("".concat(_config__WEBPACK_IMPORTED_MODULE_0__.default, "/search?q=").concat(query, "&type=").concat(type)).then(_utils__WEBPACK_IMPORTED_MODULE_1__.default);
};
